		...
		while (true) {
			...
			while (true) {
				...
				try {
					...
					if (ChessMain.chessBoard[Integer.parseInt(Character.toString(cell.charAt(1)))]
							[Integer.parseInt(Character.toString(cell.charAt(0)))].charAt(0) == move ) {
					...
					if (cell.equals(next_move) ) {
						ChessPieces.GetPiecePath(Integer.parseInt(Character.toString(cell.charAt(0))),
								Integer.parseInt(Character.toString(cell.charAt(1))));
						continue;
					} else if (ChessMain.chessBoard[Integer.parseInt(Character.toString(next_move.charAt(1)))]
							[Integer.parseInt(Character.toString(next_move.charAt(0)))].charAt(2) == '*') {	
						char name = ChessMain.chessBoard[Integer.parseInt(Character.toString(cell.charAt(1)))]
								[Integer.parseInt(Character.toString(cell.charAt(0)))].charAt(1);
						ChessPieces.movePiece(name, move, Character.getNumericValue(cell.charAt(0)), Character.getNumericValue(cell.charAt(1)),
								Character.getNumericValue(next_move.charAt(0)), Character.getNumericValue(next_move.charAt(1)));
					} else {
						ChessPieces.GetPiecePath(Integer.parseInt(Character.toString(cell.charAt(0))),
								Integer.parseInt(Character.toString(cell.charAt(1))));
