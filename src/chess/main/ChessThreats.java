				...
				if (ChessMain.chessBoard[y - offsetUp][x].charAt(0) == ' ') {
					if (skip > 1) {
						if (color == 'W') {
							...
							ChessMain.chessBoardThreatsB[y - offsetUp][x] += 1;
					}
					if (color == 'W') {
						ChessMain.chessPsThreatsW[y - offsetUp][x] += 1;
					} else
						ChessMain.chessPsThreatsB[y - offsetUp][x] += 1;
				} else {
				...
				if (ChessMain.chessBoard[y][x - offsetLeft].charAt(0) == ' ') {
					if (skip > 1) {
						if (color == 'W') {
							...
							ChessMain.chessBoardThreatsB[y][x - offsetLeft] += 1;
					}
					if (color == 'W') {
						ChessMain.chessPsThreatsW[y][x - offsetLeft] += 1;
					} else
						ChessMain.chessPsThreatsB[y][x - offsetLeft] += 1;
				} else {
				...
				if (ChessMain.chessBoard[y + offsetDown][x].charAt(0) == ' ') {
					if (skip > 1) {
						if (color == 'W') {
							...
							ChessMain.chessBoardThreatsB[y + offsetDown][x] += 1;
					}
					if (color == 'W') {
						ChessMain.chessPsThreatsW[y + offsetDown][x] += 1;
					} else
						ChessMain.chessPsThreatsB[y + offsetDown][x] += 1;
				} else {
				...
				if (ChessMain.chessBoard[y][x + offsetRight].charAt(0) == ' ') {
					if (skip > 1) {
						if (color == 'W') {
							...
							ChessMain.chessBoardThreatsB[y][x + offsetRight] += 1;
					}
					if (color == 'W') {
						ChessMain.chessPsThreatsW[y][x + offsetRight] += 1;
					} else
						ChessMain.chessPsThreatsB[y][x + offsetRight] += 1;
				} else {
				...
				if (ChessMain.chessBoard[y - offsetUp][x - offsetUp].charAt(0) == ' ') {
					if (skip > 1) {
						if (color == 'W') {
							...
							ChessMain.chessBoardThreatsB[y - offsetUp][x - offsetUp] += 1;
					}
					if (color == 'W') {
						ChessMain.chessPsThreatsW[y - offsetUp][x - offsetUp] += 1;
					} else
						ChessMain.chessPsThreatsB[y - offsetUp][x - offsetUp] += 1;
				} else {
					if (ChessMain.chessBoard[y - offsetUp][x - offsetUp].charAt(0) != color) {
						...
						if (color == 'W') {
							...
							ChessMain.chessPsThreatsB[y - offsetUp][x - offsetUp] += (!switch_) ? 1 : -1;
					} else {
						break;
					}
				}
				...
				if (ChessMain.chessBoard[y + offsetLeft][x - offsetLeft].charAt(0) == ' ') {
					if (skip > 1) {
						if (color == 'W') {
							...
							ChessMain.chessBoardThreatsB[y + offsetLeft][x - offsetLeft] += 1;
					}
					if (color == 'W') {
						ChessMain.chessPsThreatsW[y + offsetLeft][x - offsetLeft] += 1;
					} else
						ChessMain.chessPsThreatsB[y + offsetLeft][x - offsetLeft] += 1;
				} else {
				...
				if (ChessMain.chessBoard[y + offsetDown][x + offsetDown].charAt(0) == ' ') {
					if (skip > 1) {
						if (color == 'W') {
							...
							ChessMain.chessBoardThreatsB[y + offsetDown][x + offsetDown] += 1;
					}
					if (color == 'W') {
						ChessMain.chessPsThreatsW[y + offsetDown][x + offsetDown] += 1;
					} else
						ChessMain.chessPsThreatsB[y + offsetDown][x + offsetDown] += 1;
				} else {
				...
				if (ChessMain.chessBoard[y - offsetRight][x + offsetRight].charAt(0) == ' ') {
					if (skip > 1) {
						if (color == 'W') {
							...
							ChessMain.chessBoardThreatsB[y - offsetRight][x + offsetRight] += 1;
					}
					if (color == 'W') {
						ChessMain.chessPsThreatsW[y - offsetRight][x + offsetRight] += 1;
					} else
						ChessMain.chessPsThreatsB[y - offsetRight][x + offsetRight] += 1;
				} else {
				...
				if (ChessMain.chessBoard[y - offsetUp][x].charAt(0) == ' ') {
					...
					if (ChessMain.chessBoard[y - offsetUp][x].charAt(0) != color) {
						...
						if (color == 'W') {
							...
							ChessMain.chessPsThreatsB[y - offsetUp][x] += (!switch_) ? 1 : -1;
					} else {
						break;
					}
				}
